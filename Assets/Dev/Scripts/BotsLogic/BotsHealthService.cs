...
namespace Dev.BotsLogic
{
    public class BotsHealthService : NetworkContext
    {
        ...
        [Inject]
        private void Construct(BotsController botsController, GameStaticDataContainer gameStaticDataContainer,
                               GameSettings gameSettings, TeamsService teamsService,
                               WorldTextProvider worldTextProvider, HealthObjectsService healthObjectsService)
        {
